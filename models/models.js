...
const Device = sequelize.define("device", {
  ...
  installmentPrice: { type: DataTypes.INTEGER, allowNull: true },
...
const Orders = sequelize.define("orders", {
  ...
  status: { type: DataTypes.STRING, defaultValue: "unfinished" },
});
...
const Payment = sequelize.define("payment", {
  ...
  orderKey: { type: DataTypes.STRING, allowNull: false },
  orderNumber: { type: DataTypes.BIGINT, allowNull: false },
